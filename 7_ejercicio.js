...
const sumScores = rpgGames.reduce((acc, gameScore) => acc + gameScore.score, 0)

const averageRPG = sumScores / rpgGames.length

console.log(rpgGames)
console.log("Media de los juegos RPG:", averageRPG)
